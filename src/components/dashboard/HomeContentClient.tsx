        ...
        <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
                <div className="dark:bg-gray-800 bg-white p-3 sm:p-4 shadow rounded-lg text-center">
                    ...
                    <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">152 Pares - $11.1MM</p>
                </div>
                <div className="dark:bg-gray-800 bg-white p-3 sm:p-4 shadow rounded-lg text-center">
                    ...
                    <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">40 Pares - $1.6MM</p>
                </div>
                <div className="dark:bg-gray-800 bg-white p-3 sm:p-4 shadow rounded-lg text-center">
                    ...
                    <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">192 Pares - $12.7MM</p>
                </div>
