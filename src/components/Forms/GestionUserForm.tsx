...
export default function GestionUserForm({ isOpen, onClose, usuario }: GestionUserFormProps) {
  ...
  const tiendDisponibles = stores.filter(store => 
    !tiendAsignadas.some(userStore => userStore.storeID === store.storeID)
  )
      ...
      <form onSubmit={handleSubmit} className="p-6 space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex space-x-3">
            ...
            >
                <SelectTrigger
                    className="flex-1 px-3 py-2 border border-gray-300 dark:bg-slate-800 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm"
                >
              ...
              tiendAsignadas.map((store, index) => (
                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <span className="font-medium dark:text-white text-gray-900">{store.name}</span>
